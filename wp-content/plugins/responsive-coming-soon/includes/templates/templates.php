...
<div class="row">
				...
				<div class="col-md-6  demoftr "> 
					<div class="">
						<div class="enigma_home_portfolio_showcase">
							<img class="enigma_img_responsive ftr_img"  src="<?php echo  WPSM_RCS_PLUGIN_URL.'images/demo-1-img.png'; ?>">
							<div class="enigma_home_portfolio_showcase_overlay">
								<div class="enigma_home_portfolio_showcase_overlay_inner ">
									<div class="enigma_home_portfolio_showcase_icons">
									<?php if($templates != $i) { 
									?>
										<a class="activate-button" href="#activate" id="activate<?php  echo $i; ?>" onclick="hide_activate(<?php echo $i; ?>)"><?php _e('Activate','WPSM_RCS_TEXT_DOMAIN'); ?> </a>
									<?php
									}?>
										<a  href="<?php echo home_url(); ?>?wpsm_coming_soon_pro_preview=true&number=<?php echo $i; ?>&TB_iframe=true&width=900&height=80" class="thickbox" title="<?php _e('Responsive Coming Soon Preview Window','WPSM_RCS_TEXT_DOMAIN'); ?>" ><?php _e('Live Preview','WPSM_RCS_TEXT_DOMAIN'); ?></a>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="panel panel-primary save-button-block">
		<div class="panel-body">
			<div class="pull-left">
				<button type="button" class="btn btn-info btn-lg" onclick="wpsm_rcs_option_data_save('templates')"><?php _e('Save Changes','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
			<div class="pull-right">
				<button type="button" class="btn btn-primary btn-lg" onclick="wpsm_rcs_option_data_reset('templates')"><?php _e('Reset Default','WPSM_RCS_TEXT_DOMAIN'); ?></button>
			</div>
		</div>
	</div>
